...
public class MyWebView extends WebView implements NestedScrollingChild3, ScrollingView,NestedScrollingParent3 {
     ...
     *
     * @see #setOnScrollChangeListener(NestedScrollView.OnScrollChangeListener)
     */
...
//        a.recycle();
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        final NestedScrollView.LayoutParams lp = (FrameLayout.LayoutParams) child.getLayoutParams();
        final int length = getVerticalFadingEdgeLength();
...
//                    0, 0); // overscroll
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final MyWebView nsvHost = (MyWebView) host;
